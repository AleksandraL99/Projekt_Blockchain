    ...
    async function OnChangeFile(e) {
        ...
        try {
            ...
            if (response.success === true) {
                ...
                enableButton();
                updateMessage("Failed to upload image to IPFS");
            }
        } catch (e) {
            enableButton();
            updateMessage("Upload error: " + e.message);
        }
    }
    ...
    async function uploadMetadataToIPFS() {
        ...
        try {
            ...
            if (response.success === true) {
                ...
                updateMessage("Failed to upload NFT metadata to IPFS");
                return -1;
            }
        } catch (e) {
            updateMessage("Upload error: " + e.message);
    ...
    async function listNFT(e) {
        ...
        try {
            ...
            try {
                ...
                updateMessage("Failed to create NFT: " + err.message);
            }
